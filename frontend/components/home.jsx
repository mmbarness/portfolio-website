...
export const Home = (props) => {
    ...
    return (
        <div id="home-container">
            ...
            <button className='page-button' id="resume-button" onClick={()=> setresumeModalVisible(!resumeModalVisible)}>Resume</button>  
            {Resume({resumeModalVisible, setresumeModalVisible})}
            {EmailMe()}
            </div>
        </div>
    )
